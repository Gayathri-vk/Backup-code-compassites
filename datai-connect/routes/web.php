...
Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'role:admin']], function () {
    ...
    Route::get('/role', 'AdminController@createRole');
    Route::get('/role/edit/{id}', 'AdminController@editRole');
    Route::post('/role/create', 'AdminController@storeRole');
...
Route::group(['prefix' => '/{username}', 'middleware' => 'auth'], function ($username) {
    ...
    Route::get('/posts', 'TimelineController@showTimeline');
...
Route::group(['prefix' => '/{username}/settings', 'middleware' => ['auth', 'editown']], function ($username) {
    ...
    Route::get('/professional', 'UserController@userProfessionalSettings');
