...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $settings = ['comment_privacy'                    => 'everyone',
                            ...
                            'site_name'                   => 'Datai-Connect',
                            'site_title'                  => 'Datai-Connect',
                            'site_url'                    => 'datai-connect.lan',
                            ...
                            'birthday'                    => 'off',
                            'city'                        => 'off',
                            'about'                       => 'Datai-Connect is the FIRST Social networking script developed on Laravel with all enhanced features, Pixel perfect design and extremely user friendly. User interface and user experience are extra added features to Datai-Connect. Months of research, passion and hard work had made the Datai-Connect more flexible, feature-available and very user friendly!',
                            'contact_text'                => 'Contact page description can be here',
                            'address_on_mail'             => '<strong>Datai-Connect</strong>,<br> Datai-Connect street,<br> India',
                            'items_page'                  => '10',
                            'min_items_page'              => '5',
                            ...
                            'home_welcome_message'        => 'Welcome To Datai-Connect Laravel Application',
                            ...
                            'home_list_heading'           => 'Enhancing Features of Datai-Connect',
                            ...
                            'home_feature_five'            => 'Connect to Datai-Connect through Facebook, Twitter, Google Plus and Instagram',
                            ...
                            'home_feature_nine'            => 'Datai-Connect is multi-lingual and available in 16 languages',
                            'home_feature_ten_icon'       => 'user-plus',
                            'home_feature_ten'            => 'Affiliate System adds an extra flavour to Datai-Connect',
                            ];
