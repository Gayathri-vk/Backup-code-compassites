										...
										<div class="connect-list">
											...
											@if($timeline->id == Auth::user()->timeline_id)
												<div class="side-right follow-links">
													...
													<div class="left-col"><a href="#" class="btn btn-to-follow btn-default follow-user follow" data-timeline-id="{{ $follower->timeline_id }}"><i class="fa fa-user-plus"></i> {{ trans('common.follow') }} </a></div>
													...
													@else
													<div class="left-col hidden"><a href="#" class="btn btn-to-follow btn-default follow-user follow " data-timeline-id="{{ $follower->timeline_id }}"><i class="fa fa-user-plus"></i> {{ trans('common.follow') }}</a></div>
