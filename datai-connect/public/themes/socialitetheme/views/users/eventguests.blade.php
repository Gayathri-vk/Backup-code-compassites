										...
										<div class="connect-list">
											...
											@if($event->users->contains($event_guest->id) && Auth::user()->id != $event_guest->id)
												<div class="side-right follow-links">
													...
													<div class="left-col"><a href="#" class="btn btn-to-follow btn-default follow-user follow" data-timeline-id="{{ $event_guest->timeline_id }}"><i class="fa fa-user-plus"></i> {{ trans('common.follow') }} </a></div>
													...
													@else
													<div class="left-col hidden"><a href="#" class="btn btn-to-follow btn-default follow-user follow " data-timeline-id="{{ $event_guest->timeline_id }}"><i class="fa fa-user-plus"></i> {{ trans('common.follow') }}</a></div>
