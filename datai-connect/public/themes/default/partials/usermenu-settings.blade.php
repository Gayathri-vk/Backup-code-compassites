...
<div class="list-group list-group-navigation socialite-group">
	...
	<a href="{{ url('/'.Auth::user()->username.'/settings/professional') }}" class="list-group-item">
		<div class="list-icon socialite-icon {{ Request::segment(3) == 'professional' ? 'active' : '' }}">
			<i class="fa fa-user"></i>
		</div>
		<div class="list-text">
			Professional Settings
			<div class="text-muted">
				Add Work,Education,Skills
			</div>
		</div>
		<div class="clearfix"></div>
	</a>
