<div class="panel panel-default">
	...
	@include('flash::message')
		...
		<form method="POST" onsubmit="return validateRoleForm()" action="{{ url('admin/role/update') }}" class="socialite-form">
			{{ csrf_field() }}
		...
		<label class="col-sm-10 control-label">Permissions:</label>
		<div class="col-sm-10">
                ...
                @foreach($permissions as $permission)
                    <li class="clearfix checkbox">
                        ...
                        <input type="checkbox" name="permissions[]"
                            value="{{$permission->id}}" @if(in_array($permission['id'], $selectedpermission))
                                checked
                             @endif/>
                            {{$permission->name}}
                        </label>
