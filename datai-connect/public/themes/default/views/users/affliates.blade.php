						...
						<div class="affiliate-settings">
							...
							<ul class="list-group affliate-followers">
								...
								<li class="list-group-item">
									...
									<div class="pull-right"><a href="#" class="btn btn-to-follow btn-default follow-user follow" data-timeline-id="{{ $referral->timeline_id }}"><i class="fa fa-user-plus"></i> {{ trans('common.follow') }} </a></div>
									...
									@else
									<div class="pull-right hidden"><a href="#" class="btn btn-to-follow follow-user btn-default follow " data-timeline-id="{{ $referral->timeline_id }}"><i class="fa fa-user-plus"></i> {{ trans('common.follow') }}</a></div>
