...
<div class="user-avatar-progress hidden">
     ...
     <div class=" col-md-6 col-sm-6 col-xs-6 unfollow">

      
      @if($timeline->id == Auth::user()->timeline_id)
                        <div class="side-right follow-links">
                          @if(!$user->following->contains($follower->id))
                          <div class="left-col"><a href="#" class="btn btn-to-follow btn-default follow-user follow" data-timeline-id="{{ $follower->timeline_id }}"><img src="{{url('themes/default/assets/images/customicons/icon.svg')}}" alt="unfollow-icon"/> <label class="unfollow-icon-label">{{ trans('common.follow') }}</label> </a></div>

                          <div class="left-col hidden"><a href="#" class="btn follow-user btn-success unfollow " data-timeline-id="{{ $follower->timeline_id }}"><img src="{{url('themes/default/assets/images/customicons/icon.svg')}}" alt="unfollow-icon"/> <label class="unfollow-icon-label">{{ trans('common.following') }}</label> </a></div>
                          @else
                          <div class="left-col hidden"><a href="#" class="btn btn-to-follow btn-default follow-user follow " data-timeline-id="{{ $follower->timeline_id }}"><img src="{{url('themes/default/assets/images/customicons/icon.svg')}}" alt="unfollow-icon"/> <label class="unfollow-icon-label">{{ trans('common.follow') }}</label> </a></div>
                          <div class="left-col"><a href="#" class="btn follow-user btn-success unfollow" data-timeline-id="{{ $follower->timeline_id }}"><img src="{{url('themes/default/assets/images/customicons/icon.svg')}}" alt="unfollow-icon"/> <label class="unfollow-icon-label">{{ trans('common.following') }}</label> </a></div>
                          @endif
                        </div>
                      @endif
                    </div> 
      ...
      <a href="#" class="btn btn-options btn-block btn-default" onClick="chatBoxes.sendMessage({{ $timeline->user->id }})"> <img src="{{url('themes/default/assets/images/customicons/message.svg')}}" alt="message-icon"/> <label class="send-message-icon-label">MESSAGE</label> </a>
      </div>
